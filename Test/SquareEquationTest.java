...
public class SquareEquationTest{
    ...
    @BeforeEach
    void setUp()throws Exception{//Ta metoda jest wywolywana pierwsza.
        se=new SquareEquation(5, 1, -3);//Stworzenie natychmiastowego dostepu(instance) do klasy SquareEquation.
